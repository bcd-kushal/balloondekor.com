...
export const getUnits = ({
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const url: string = `${DOMAIN}${UNIT_API}${queryParams}`;
...
export const getUnit = (
  ...
  return new Promise(async (resolve, reject) => {
    try {
      const url: string = `${DOMAIN}${UNIT_API}/${unitId}`;
...
export const addUnit = (
  addData: Partial<UnitDocument>
): Promise<ResponseDataType> => {
  return new Promise(async (resolve, reject) => {
    try {
      const url: string = `${DOMAIN}${UNIT_API}`;
...
export const activateUnit = (
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      console.error(
        `Error ${isActive ? "Deactivating" : "Activating"} Unit`,
        error
      );
      ...
      reject({
        ...
        status: [
          {
            type: "error",
            message: `Couldn't ${isActive ? "Deactivate" : "Activate"} Unit, Try Again`
          }
        ]
      });
    }
