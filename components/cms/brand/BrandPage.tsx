...
import BrandList from "@/components/cms/brand/BrandList";
...
// styles
import styles from "@/components/cms/brand/brandPage.module.css";
...
export default function BrandPage() {
  ...
  const handleToggleBrandActive = (
    brandId: string,
    isActive: boolean
  ): void => {
    activateBrand(brandId, isActive)
      .then((responseData: ResponseDataType) => {
        addStatus(responseData.status);
        setBrands((prevBrands) =>
          prevBrands.map((prevBrand) => {
            if (prevBrand._id === brandId) {
              prevBrand.isActive = isActive;
            }
