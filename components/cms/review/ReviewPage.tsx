...
import ReviewList from "@/components/cms/review/ReviewList";
...
// styles
import styles from "@/components/cms/review/reviewPage.module.css";
...
export default function ReviewPage() {
  ...
  const handleToggleReviewActive = (
    reviewId: string,
    isActive: boolean
  ): void => {
    activateReview(reviewId, isActive)
      .then((responseData: ResponseDataType) => {
        addStatus(responseData.status);
        setReviews((prevReviews) =>
          prevReviews.map((prevReview) => {
            if (prevReview._id === reviewId) {
              prevReview.isActive = isActive;
            }
